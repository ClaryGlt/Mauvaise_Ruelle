...
public class AdModel {
    ...
    // Constructor
    public AdModel(String title, String address, String marque, int prix, int id_obj, String description, String dimension, String categorie, String nom_image, int id_vendeur) {
